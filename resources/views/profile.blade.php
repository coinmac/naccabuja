...
@section('content')
    ...
    <div class="card-body">
          ...
          <h5>My Profile - {{$profile->company_name." (".auth()->user()->name." ".auth()->user()->othernames.")"}}<a href="{{url('edit_profile')}}" class="btn btn-inline btn-sm btn-danger float-right" >Edit profile</a> </h5>
            <hr>
                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="Business_Activities" class="form-control editor" rows="5" name="business_activities">{{$profile->business_activities}}</textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="partner1" id="partner1" placeholder="Partners Name" value="{{array_values(explode('-',$profile->partner1))[0]}}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                      ...
                                      @if ($profile->partner1)
                                        value="{{array_values(explode('-',$profile->partner1))[1]}}"
                                      @endif
                                      >
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" name="partner2" id="partner2" placeholder="Partners Name" value="{{array_values(explode('-',$profile->partner2))[0]}}">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                          ...
                                          @if ($profile->partner2)
                                          value="{{array_values(explode('-',$profile->partner2))[1]}}"
                                        @endif
                                        >
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" name="partner3" id="partner3" placeholder="Partners Name" value="{{array_values(explode('-',$profile->partner3))[0]}}">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                          ...
                                          @if ($profile->partner3)
                                          value="{{array_values(explode('-',$profile->partner3))[1]}}"
                                        @endif
                                          >
                                        </div>
                                    </div>
                          ...
                          <div class="card-body">
                            ...
                            <div class="form-group">
                              ...
                              @if ($profile->financial_report!="")
                                <a href="/uploads/{{$profile->financial_report}}" target="_blank">Download Financial Report</a><br> <small><em>Upload a New One to Change?</em></small>
                              @endif
                            ...
                            <div class="form-group">
                              ...
                              @if ($profile->form_c07!="")
                                <a href="/uploads/{{$profile->form_c07}}" target="_blank">Download Form C07</a><br> <small><em>Upload a New One to Change?</em></small>
                              @endif
                            ...
                            <div class="form-group">
                              ...
                              @if ($profile->cac!="")
                                <a href="/uploads/{{$profile->cac}}" target="_blank">Download Certificate of Incorporation</a><br> <small><em>Upload a New One to Change?</em></small>
                              @endif
                            ...
                            <div class="form-group">
                              ...
                              @if ($profile->passport!="")
                                <a href="/uploads/{{$profile->passport}}" target="_blank">Download passport</a><br> <small><em>Upload a New One to Change?</em></small>
                              @endif
...
<div class="card" style="font-size: 0.8em !important">
  <div class="card-body">
    <h5 class="card-title">Basic Info</h5>
    <hr>
<img class="card-img-top" src="{{url('uploads/'.$profile->passport)}}" alt="{{$profile->passport}}">
<hr>
<label for="mno" class="text-center align-center center">Member ID:</label>
  <h6 id="mno" class="text-center center p-1" style="font-size: 0.9em !important; display:block; background-color:lime;">{{strtoupper($profile->memberno)}}</h6>
  <hr>
<form action="{{url('updatepassport', auth()->user()->id)}}" method="post" enctype="multipart/form-data">
    @csrf
    @method('put')

    <div class="form-group">
      <label for="passport">Upload/Change Passport</label>
      <input type="file" class="form-control-file" name="passport" id="passport" aria-describedby="helppassport">
      <small id="helppassport" class="form-text text-muted">Passport must be jpeg not more than 100KB</small>
    </div>
